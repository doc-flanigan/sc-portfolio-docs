...
claim: "Foundation Festival 2026 launches July 29, 2026, per CIG's official Twitch Drops comm-link. A referral mechanic (recruit a new player, earn a free Argo ATLS) is teased for the event but full terms are not yet published. No Free Fly component and no festival end date have been officially confirmed as of this check."
status: verified
sources:
